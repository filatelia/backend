...
const crearReporte = async (req, res = response ) =>{
    ...
    if (usuarioReportadoBD == null) {
        ...
        return res.json({
            ok: false,
            msg: "Error en consultar los datos del cliente reportado | usuarioReportadoBD"
        });
    }
    ...
    if (usuarioReportanteBD == null) {
        ...
        return res.json({
            ok: false,
            msg: "Error en consultar los datos del cliente reportante | usuarioReportanteBD"
        });
    }
     ...
     */
     const tipoEstadoReporteBD = await consultarTipoEstadoReporteConAbreviacion("NP.CEA");
     if(tipoEstadoReporteBD == false){
         return res.json({
             ok: false,
             msg: "No se  puedo crear reporte, error en consultar el estado del reporte."
         });
     }
